...
Mloop:
 ...
 ; Writing player name to the file
...
;//////////////////////////////// Writing code for displaying text on file //////////
...
nameScore PROC
    ...
    ; Write buffer content (player name) to the file
    mov edx, OFFSET buffer
    mov eax, fileHandle
    call WriteToFile
    jc error_message
    comment @
    ; Write a space after the name
   ...
   ; jc error_message
    ...
    ; Write a newline after the score
    mov edx, OFFSET newLine
    mov ecx, 2
    call WriteToFile
    jc error_message
